...
const LoginPage = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string()
        .min(1, "Invalid phone ")
        .email("@ belgisidan foydalaning")
        .required(`Email to'liq to'g'ri to'ldirilishi shart`),
    }),
    onSubmit: (values) => {
    ...
    <div>
      ...
      >
        <Form noValidate className="w-25" onSubmit={formik.handleSubmit}>
          <h2 className="text-center mb-4 pb-2" style={{ color: "#838383" }}>
            Login
          </h2>
          <Form.Group
          ...
          <Button type="submit" className="w-100 mt-2 py-3">
            LOGIN
          </Button>
        </Form>
        <img
